<?php
include ("projectlayout/header.php");
?>
        ...
        <div class="primary col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="item featured text-center">
                            ...
                            <div class="featured-image">
                                <a href="http://100haofang.cn" target="_blank">
                                    <img class="img-responsive project-image" src="images/100haofang1.png" alt="project name" />
                                </a>
                                <div class="ribbon">
                            ...
                            <img class="img-responsive project-image" src="images/100haofnag2.png" alt="project name" />
            ...
            <section class="projects section">
                <div class="section-inner">
                    ...
                    <div class="content">
                        <div class="item">
                            <h3 class="title"><a href="project2.php">微推广平台</a></h3>
                        ...
                        <div class="item">
                            ...
                            <p><a class="more-link" href="project.html" target="_blank"><i class="fa fa-external-link"></i> 了解更多 </a></p>
                        </div><!--//item-->
                        <div class="item">
                            <h3 class="title"><a href="project3.php">08cms下的旺屋</a> <span class="label label-theme">旺屋</span></h3>
...
<!-- ******FOOTER****** -->
<?php
include ("projectlayout/footer.php");
?>
</body>
</html>
